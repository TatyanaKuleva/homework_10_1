...
def test_get_mask_account_right_len(get_number_account):
    with pytest.raises(ValueError) as mis_len_account:
        get_mask_account(get_number_account)


@pytest.mark.parametrize(
    "get_number_account", [("7365410843013584D05"), ("asdkflfndls;dkfl"), ("7365410843013584 05")]
)
def test_get_mask_card_account_no_all_digit(get_number_account):
